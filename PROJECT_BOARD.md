...
| Core Customer Journey Hardening | https://github.com/watsonjohn-spec/Forget-About-Tray/issues/3 | Third slice complete: account order details now show expected delivery, reminder count, auto-release warning date, and delivery-confirmation history. |
...
| Core Customer Journey Hardening | https://github.com/watsonjohn-spec/Forget-About-Tray/issues/3 | Wire the email outbox to a real provider, add explicit buyer escalation handling, and add provider-visible delivery chaser status. |
