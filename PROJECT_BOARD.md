...
| Core Customer Journey Hardening | https://github.com/watsonjohn-spec/Forget-About-Tray/issues/3 | Fourth slice complete: buyers can escalate delivery issues from order detail, and escalated jobs are excluded from automatic completion/payout release. |
...
| Core Customer Journey Hardening | https://github.com/watsonjohn-spec/Forget-About-Tray/issues/3 | Wire the email outbox to a real provider and add provider/admin-visible escalation handling queues. |
